...
const WORDS = ["MERN Stack Developer", "Problem Solver"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/siddhesh0533" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/siddhesh-patil-bba162276/" },
  { icon: Instagram, link: "https://www.instagram.com/siddheshpatil0533/" }
];
      ...
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[0%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            {/* Left Column */}
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0 lg:ml-24"
              data-aos="fade-right"
              data-aos-delay="200">
            ...
            <div className="w-full py-[10%] sm:py-0 lg:w-1/2 h-auto lg:h-[600px] xl:h-[750px] relative flex items-center justify-center order-2 lg:order-2 mt-8 lg:mt-0"
              ...
              <div className="relative w-full opacity-90">
                ...
                <div className={`relative z-10 w-full opacity-90 transform transition-transform duration-500 ${
                  ...
                  <div className={`w-[300px] h-[300px] transition-all duration-500 ease-in-out ml-40 ${
                    isHovering 
                      ? "scale-[180%] sm:scale-[160%] md:scale-[150%] lg:scale-[145%] rotate-2" 
                      : "scale-[175%] sm:scale-[155%] md:scale-[145%] lg:scale-[140%]"
                  }`}>
